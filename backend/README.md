...
## Project Structure
    ...
    ├── testapiautocatalog_113772  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_113772`
...
2. Clone this repo and `cd testapiautocatalog_113772`
